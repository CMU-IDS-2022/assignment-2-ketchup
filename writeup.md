...
Our application consists of 7 parts. In part 1, we provide statistical summaries of the survey. In part 2 and 3, we demonstrate the correlations between demographics and two factors: whether the couple sleep together or not, and the frequency of sleeping separately. In part 4, we introduce the most interesting part of the application - the reasons why couples sleep separately. In part 5, we investigate the respondents' opinions of three questions regarding sleeping separately. In part 6, we look at the locations that each of the couple sleep if they sleep separately. In part 7, we allow users to randomly select an individual in the dataset.
