...
As a person whose parents sleep separately, this application helps me answer this difficult question since childhood, even in greater detail. When I was a child, I related sleeping separately to aloofness, and I was afraid my parents had an unhappy marriage. I didn't understand. They were just like other couples; they laughed and joked in each other's company. It was until this project that I finally realized that hundreds of couples don't sleep with their partner as well. The reasons behind that are not necessarily associated with the emotional relationship.
